...
4. Cliquer sur **Analyser** : l'arborescence correspondant aux choix ci-dessus, avec le
   ...
   La lecture des dates est parallélisée sur plusieurs fichiers à la fois pour accélérer
   l'analyse des dossiers volumineux. Si elle prend malgré tout trop de temps, le bouton
   **Annuler** (à côté d'Analyser) l'interrompt à la volée.
